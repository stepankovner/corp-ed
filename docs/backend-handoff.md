...
| BH-27 запасная модель при `content_filter` | ✗ отклонён Артёмом 26.09: остаётся отказ по BH-25; описание — в приложении, на будущее |
...
- **Решение Артёма 26.09: не делаем.** Остаётся отказ по BH-25; ~4 %
  вопросов по грантовым положениям получат отказ там, где ответ в
  документах есть. Пункт оставлен как описание на случай, если доля
  вырастет на корпусе клиента.
